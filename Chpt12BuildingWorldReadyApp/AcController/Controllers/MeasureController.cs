...
public class MeasureController : ControllerBase
{
    ...
    private static readonly Measurement[] _measurements =
        new[]
        {
    ...
    [HttpGet("{site}/{unitId}")]
    public Temperatures Get([FromRoute] string site, [FromRoute] int unitId)
    {
        return new Temperatures(unitId, site, DateTimeOffset.UtcNow, _measurements);
    }
}
